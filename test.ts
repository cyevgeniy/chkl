...
const fullExample: Checklist = {
  ...
  items: [
    ...
    },
    {
      ...
      content_text:
        "Create a pull request. We attached a small video instruction on how to create pull requests",
      blocking: true,
      attachments: [
        {
...
const extendedExample: Checklist = {
  _test: "123",
  items: [
    {
      id: "1",
